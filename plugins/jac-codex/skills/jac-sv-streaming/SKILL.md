...
description: Streaming endpoints using SSE, public generator functions, `report stream()`, progress updates, live feeds, token-by-token output, service-to-service pass-through, and browser stream consumption. Load when an endpoint must deliver incremental results.
---
