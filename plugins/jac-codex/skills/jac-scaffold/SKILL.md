---
name: jac-scaffold
description: Bootstrapping a new Jac project with `jac create --use`, understanding generated layouts, applying the post-scaffold checklist, and choosing standard versus jac-shadcn. Load when starting a new project from scratch.
---
