...
description: Server endpoints - REST walker and function routes, walker:pub, choosing walker versus function shape, response envelopes, @restspec custom routes and methods, file uploads, and typed responses. Use for any REST consumer, not only the Jac client.
---
